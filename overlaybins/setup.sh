...
export LD_LIBRARY_PATH=/opt/xilinx/xrt/lib:${MLSUITE_ROOT}/overlaybins/${DEVICE}/runtime/lib/x86_64/:${MLSUITE_ROOT}/xfdnn/rt/xdnn_cpp/build/lib:${MLSUITE_ROOT}/xfdnn/rt/lib:${MLSUITE_ROOT}/ext/boost/lib:${MLSUITE_ROOT}/ext/zmq/libs:$PWD
